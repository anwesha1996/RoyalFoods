    ...
    if(isset($_GET['action']) && $_GET['action']=="add"){ 
        ...
        if(isset($_SESSION['cart'][$id])){ 
            ...
            foreach ($conn->query($sql_s) as $row_s){
               $_SESSION['cart'][$row_s['subitemid']]=array( 
                        "quantity" => 1, 
                        "price" => $row_s['itemprice'],
                        "subitemid" => $row_s['subitemid']
                    );  
            }
...
<!--Third Slide-->
                   ...
                   <?php 
                    ...
                    <div class="product-info">
                           ...
                           <select class="form-control select2" style=" font-size:12px;width:64px; height:30px; margin-left:-6px" name="quantity">
                            ...
                            <a href="index2.php?page=products&action=add&id=<?php echo $itm1['subitemid']; ?>" class="label label-danger pull-right" style="margin-top:-26px; margin-right:60px; font-size:16px">ADD</a>
                         <span class="label label-success pull-right" style="margin-top:-26px; margin-right:-5px; font-size:16px"><i class="fa fa-rupee"></i><?php echo $itm1['itemprice']; ?></span>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2015-2016 <a href="http://inss.in">Interface Software Services</a>.</strong> All rights reserved.
      </footer>
