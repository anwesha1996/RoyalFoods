...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Royal Foods | Customer Orders</title>
                  ...
                  <div class="table-responsive" style="height:400px">
                    ...
                    <table class="table no-margin"  >
                      ...
                      <tbody>
                          <?php $i=0; ?>
                            <?php
                              $query="select * from tbl_customerdetails where customerstatus='New' order by customerid desc";
                       ...
                       <td><a class="label label-success" onclick="return confirm('Are you sure?')" href="changestatus.php?customerid=<?php echo $row['customerid']; ?>"></i><?php echo $row['customerstatus']; ?></a></td>
                       <td><?php echo $row['orderdate']; ?></td>
                       <td><?php echo $row['ordertime']; ?></td>
                          
                        <td><a href="customerorderdetails.php?customerid=<?php echo $row['customerid']; ?>"  class="label label-warning"><i class="fa fa-pencil-square-o"></i>&nbsp;View</a></td>
                        <td> <a class="label label-danger"><i class="fa fa-trash"></i>&nbsp;Remove</a></td>
